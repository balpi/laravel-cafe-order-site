    ...
    <div class="container py-5">
        <div class="row justify-content-start">
            <div class="col-lg-8 text-center text-lg-start">
                <h1 class="font-secondary text-primary mb-4">DenizCafe</h1>
                <h1 class="display-1 text-uppercase text-white mb-4">Quality</h1>
                <h1 class="text-uppercase text-white">The Best Product In Bodrum</h1>
            ...
            <div class="tab-class text-center">
                ...
                <div class="tab-content">
                    @foreach ($categories as $category)
                        @if ($loop->first)
                            <div id="tab-{{ $category->ID }}" class="tab-pane fade show p-0 active">
                            @else
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex h-100">
                                                <div class="col-6 text-center">
                                                    <a href="{{ route('order_addDirect', ['id' => $product->ID]) }}"
